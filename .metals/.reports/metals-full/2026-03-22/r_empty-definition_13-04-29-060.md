error id: file:///C:/Users/Admin/rust-advanced/kv-graph-pipeline/kv-graph-spark/src/main/scala/KvGraphJob.scala:
file:///C:/Users/Admin/rust-advanced/kv-graph-pipeline/kv-graph-spark/src/main/scala/KvGraphJob.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -org/apache/spark/sql/functions/org/apache.
	 -org/apache/spark/sql/types/org/apache.
	 -org/apache.
...
text:
```scala
import org.apa@@che.spark.sql.SparkSession
